// ==UserScript==
// @name         Torn Money Coach PDA Ultimate
// @namespace    https://torn.com/
// @version      5.1.0
// @description  PDA-first Money Coach with crime guidance, profit tracking, license gating, mode toggle, faction branding, and expiration lockout
// @author       Curtdahurt
